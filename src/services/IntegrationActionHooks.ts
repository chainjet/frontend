...
import { IntegrationAction, IntegrationActionConnection, IntegrationActionFilter, IntegrationActionSort } from '../../graphql'
...
export function useGetIntegrationActions (
  fragment: DocumentNode,
  options: QueryHookOptions<{ integrationActions: IntegrationActionConnection }, QueryMany<IntegrationActionFilter, IntegrationActionSort>>
) {
  ...
  return useQuery<{ integrationActions: IntegrationActionConnection }, QueryMany<IntegrationActionFilter, IntegrationActionSort>>(query, options)
}
