...
export function getIntegrationNodeFromWorkflowNode (
  workflowNode: WorkflowNode
): IntegrationNode {
  return (
    (workflowNode as WorkflowTrigger)?.integrationTrigger ||
    (workflowNode as WorkflowAction)?.integrationAction
  )
}

export function getIntegrationFromWorkflowNode (
  workflowNode: WorkflowNode
): Integration {
