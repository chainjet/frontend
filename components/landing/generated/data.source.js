...
export const Banner50DataSource = {
  ...
  childWrapper: {
    className: 'banner5-title-wrapper khjky9at56-editor_css',
    children: [
      {
        name: 'title',
        children: (
            ...
            <span>
              <span>
                <span>
                  <span>
                    <span>
                      <p>Automate your business in minutes, without writing code or paying $50,000+</p>
                    </span>
                  </span>
                </span>
              </span>
        ...
        className: 'banner5-title kgb3a49vay-editor_css',
      },
      {
        name: 'explain',
      ...
      },
      {
        ...
        children: {
          href: '/register',
          className: 'banner5-button kgebz1ako2-editor_css',
          type: 'primary',
          children: (
            <span>
              <span>
      ...
      {
        name: 'content~khjkzcicps',
        className: 'khjkzgpcyyd-editor_css',
        children: (
          <span>
            <span>
  ...
  image: {
    ...
    children: 'https://chainjet.io/images/landing/flow.png',
  },
}
...
export const Feature30DataSource = {
  ...
  page: { className: 'home-page content3 kgzaai0w3sp-editor_css' },
    ...
    children: [
      {
        ...
        children: (
          <span>
            <p>Why ChainJet is right for you?</p>
          </span>
        ),
        className: 'title-h1',
      },
    ...
    children: [
          ...
          content: {
            ...
            children: (
              <span>
                <span>
                  <p>
                    When we support an integration, we support every operation and every parameter. We want to solve
                    problems, no create limitations.
                  </p>
                </span>
              </span>
            ),
      ...
      },
      {
        ...
        children: {
          icon: {
            className: 'content3-icon',
            children: 'https://flowoid.s3.amazonaws.com/icons/unlimited.svg',
          },
          textWrapper: { className: 'content3-text' },
          title: {
            className: 'content3-title',
...
export const Content50DataSource = {
  ...
  block: {
    className: 'content5-img-wrapper kgb7uenfxko-editor_css',
    gutter: 16,
    children: [
      {
        name: 'block0',
      ...
      },
      {
        ...
        children: {
          wrapper: { className: 'content5-block-content' },
          img: {
            children: 'https://chainjet.io/logos/gitlab.svg',
      ...
      },
      {
        ...
        children: {
          wrapper: { className: 'content5-block-content' },
          img: {
            children: 'https://chainjet.io/logos/sendgrid.svg',
      ...
      },
      {
        ...
        children: {
          wrapper: { className: 'content5-block-content' },
          img: {
            children: 'https://chainjet.io/logos/docusign.png',
      ...
      },
      {
        ...
        children: {
          wrapper: { className: 'content5-block-content' },
          img: {
            children: 'https://chainjet.io/logos/twilio.svg',
      ...
      },
      {
        ...
        children: {
          wrapper: { className: 'content5-block-content' },
          img: {
            children: 'https://chainjet.io/logos/circleci.svg',
...
export const Pricing10DataSource = {
  ...
  block: {
    ...
    children: [
      {
        name: 'block0',
        className: 'pricing1-block kgqn210cjs-editor_css',
        md: 12,
        xs: 24,
        children: {
      ...
      {
        name: 'block1',
        className: 'pricing1-block kgqmzx1mttk-editor_css',
        md: 12,
        xs: 24,
        children: {
          ...
          money: {
            className: 'pricing1-money kgqn2fwaqlr-editor_css',
            children: (
              <span>
                <span>
                  <span>
...
export const Footer10DataSource = {
    ...
    children: [
      {
        ...
        xs: 24,
        md: 6,
        className: 'block kgecd2kfr6-editor_css',
        title: {
          className: 'logo kge6mhwzoos-editor_css',
          children: 'https://chainjet.io/logo-white.svg',
        },
        childWrapper: {
          className: 'slogan',
          children: [
      ...
      },
      {
        ...
        title: {
          ...
          className: 'kgec0dgwrd-editor_css',
        },
        childWrapper: {
          children: [
            {
              name: 'link0',
              href: 'https://twitter.com/flowoid',
              children: (
                <span>
                  <span>
                    <span>
      ...
      },
      {
        ...
        title: {
          ...
          className: 'kgec0haku1-editor_css',
        },
        childWrapper: {
          children: [
            {
      ...
      },
      {
        ...
        title: {
          ...
          className: 'kgec0k9yx9-editor_css',
        },
        childWrapper: {
          children: [
            {
  ...
  copyrightWrapper: { className: 'copyright-wrapper kgd26lv8199-editor_css' },
  copyrightPage: { className: 'home-page' },
  copyright: {
    className: 'copyright kgd236w17b-editor_css',
    children: (
      <span>
        <p>
          <br />
