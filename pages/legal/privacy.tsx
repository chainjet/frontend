...
function PrivacyPolicyPage() {
  return (
    <Card>
      ...
      <p>
        Welcome to <strong>Flowoid</strong>.
      </p>
      <p>
        Flowoid (“us”, “we”, or “our”) operates https://flowoid.com (hereinafter referred to as “
        <strong>Service</strong>”).
      </p>
      <p>
        Our Privacy Policy governs your visit to https://flowoid.com, and explains how we collect, safeguard and
      ...
      <p>
        Our Terms and Conditions (“<strong>Terms</strong>”) govern all use of our Service and together with the Privacy
        Policy constitutes your agreement with us (“<strong>agreement</strong>”).
      </p>

      <h3>2. Definitions</h3>
      <p>
        <strong>SERVICE</strong> means the https://flowoid.com website operated by Flowoid.
      </p>
      <p>
        <strong>PERSONAL DATA</strong> means data about a living individual who can be identified from those data (or
      ...
      <p>
        <strong>DATA CONTROLLER</strong> means a natural or legal person who (either alone or jointly or in common with
      ...
      <p>
        <strong>DATA PROCESSORS (OR SERVICE PROVIDERS)</strong> means any natural or legal person who processes the data
        on behalf of the Data Controller. We may use the services of various Service Providers in order to process your
      ...
      <p>
        <strong>THE USER</strong> is the individual using our Service. The User corresponds to the Data Subject, who is
      ...
      <p>
        ...
        be used to contact or identify you (“<strong>Personal Data</strong>”). Personally identifiable information may
      ...
      <p>
        ...
        from us by following the unsubscribe link or by emailing at admin@flowoid.com.
      </p>
      <p>
        <strong>Third-party authentication tokens, API keys and login credentials</strong>
      </p>
      <p>
        In order to integrate with third-party services, we need to use authentication tokens, API keys and/or other
        login credentials, which allow us to call a third-party service on your behalf. We securely store third-party
        authentication tokens, API keys and login credentials and we will not use them for any purposes other than those
        which have been provided for.
      </p>
      <p>
        You can remove third-party authentication tokens, API keys and login credentials and we will automatically
        delete all personal information associated with them.
      </p>
      <p>
        <strong>Third-party data</strong>
      </p>
      <p>
        When you create a connection with a third-party service, the third-part service may provide us access to certain
        information, including Personal Data. We will use and store such information in accordance with this privacy
        policy.
      </p>
      <p>
        You can use Flowoid to connect one or more third-party services in a workflow. When running a workflow we may
        send personal data to the third-party services. How third-party services use, store and disclose your
        information is governed by the privacy policies of those third-party services. Flowoid shall have no liability
        or responsibility for the practices of any third-party services.
      </p>
      <p>
      ...
      <p>
        When you access Service with a mobile device, this Usage Data may include information such as the type of mobile
      ...
      <p>
        ...
        non-disclosure agreements, information on bonuses and compensation, information on marital status, family
      ...
      <p>
        (i) to carry out our obligations and enforce our rights arising from any contracts entered into between you and
        us, including for billing and collection;{' '}
      </p>
      <p>
        (j) to provide you with notices about your account and/or subscription, including expiration and renewal
        notices, email-instructions, etc.;{' '}
      </p>
      <p>
        (k) to provide you with news, special offers and general information about other goods, services and events
      ...
      <p>
        Flowoid will take all the steps reasonably necessary to ensure that your data is treated securely and in
      ...
      <p>
        <strong>(c) Other cases. We may disclose your information also:</strong>
      </p>
      ...
      <p>
        (vii) if we believe disclosure is necessary or appropriate to protect the rights, property, or safety of the
      ...
      <p>
        ...
        systems, please email us at admin@flowoid.com.
      </p>
      <p>In certain circumstances, you have the following data protection rights: </p>
      <p>(a) the right to access, update or to delete the information we have on you; </p>
      <p>
        (b) the right of rectification. You have the right to have your information rectified if that information is
        inaccurate or incomplete;{' '}
      </p>
      <p>(c) the right to object. You have the right to object to our processing of your Personal Data; </p>
      <p>
        (d) the right of restriction. You have the right to request that we restrict the processing of your personal
        information;{' '}
      </p>
      <p>
        (e) the right to data portability. You have the right to be provided with a copy of your Personal Data in a
        structured, machine-readable and commonly used format;{' '}
      </p>
      <p>
        (f) the right to withdraw consent. You also have the right to withdraw your consent at any time where we rely on
        your consent to process your personal information;{' '}
      </p>
      <p>
        Please note that we may ask you to verify your identity before responding to such requests. Please note, we may
      ...
      <p>
        our Privacy Policy link includes the word “Privacy”, and can easily be found on the page specified above on the
      ...
      <p>
        ...
        <strong>Service Providers</strong>”), provide Service on our behalf, perform Service-related services or assist
      ...
      <p>
        ...
        ensured, please visit GitHub Privacy Policy page: https://help.github.com/en/articles/github-privacy-statement.
      </p>

      <h3>15. Behavioral Remarketing</h3>
      <p>
        Flowoid uses remarketing services to advertise on third party websites to you after you visited our Service. We
      ...
      <p>
        Facebook adheres to the Self-Regulatory Principles for Online Behavioural Advertising established by the Digital
        Advertising Alliance. You can also opt-out from Facebook and other participating companies through the Digital
        Advertising Alliance in the USA http://www.aboutads.info/choices/, the Digital Advertising Alliance of Canada in
        Canada http://youradchoices.ca/ or the European Interactive Digital Advertising Alliance in Europe
      ...
      <p>
        We do not knowingly collect personally identifiable information from Children under 18. If you become aware that
        a Child has provided us with Personal Data, please contact us. If we become aware that we have collected
